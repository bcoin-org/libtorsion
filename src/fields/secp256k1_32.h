/* Autogenerated: /src/ExtractionOCaml/unsaturated_solinas --static --tight-bounds-mul-by 1.1 secp256k1 32 12 '2^256 - 2^32 - 977' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes carry_scmul3 carry_scmul4 carry_scmul8 */
/* curve description: secp256k1 */
/* machine_wordsize = 32 (from "32") */
/* requested operations: carry_mul, carry_square, carry, add, sub, opp, selectznz, to_bytes, from_bytes, carry_scmul3, carry_scmul4, carry_scmul8 */
/* n = 12 (from "12") */
