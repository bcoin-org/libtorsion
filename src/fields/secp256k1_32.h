/* Autogenerated: /src/ExtractionOCaml/unsaturated_solinas --static --tight-bounds-mul-by 1.1 secp256k1 32 12 '2^256 - 2^32 - 977' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes */
