...
#define S (ctx->state)
  ...
  for (i = 0; i < 24; i++) {
    /* Theta */
    A = S[0] ^ S[5] ^ S[10] ^ S[15] ^ S[20];
    B = S[1] ^ S[6] ^ S[11] ^ S[16] ^ S[21];
    C = S[2] ^ S[7] ^ S[12] ^ S[17] ^ S[22];
    D = S[3] ^ S[8] ^ S[13] ^ S[18] ^ S[23];
    E = S[4] ^ S[9] ^ S[14] ^ S[19] ^ S[24];
    ...
    A = S[11]; S[11] = ROTL64(B,  6); B = A;
    A = S[17]; S[17] = ROTL64(B, 10); B = A;
    A = S[18]; S[18] = ROTL64(B, 15); B = A;
    A = S[ 3]; S[ 3] = ROTL64(B, 21); B = A;
    A = S[ 5]; S[ 5] = ROTL64(B, 28); B = A;
    A = S[16]; S[16] = ROTL64(B, 36); B = A;
    A = S[ 8]; S[ 8] = ROTL64(B, 45); B = A;
    A = S[21]; S[21] = ROTL64(B, 55); B = A;
    A = S[24]; S[24] = ROTL64(B,  2); B = A;
    A = S[ 4]; S[ 4] = ROTL64(B, 14); B = A;
    A = S[15]; S[15] = ROTL64(B, 27); B = A;
    A = S[23]; S[23] = ROTL64(B, 41); B = A;
    A = S[19]; S[19] = ROTL64(B, 56); B = A;
    A = S[13]; S[13] = ROTL64(B,  8); B = A;
    A = S[12]; S[12] = ROTL64(B, 25); B = A;
    A = S[ 2]; S[ 2] = ROTL64(B, 43); B = A;
    A = S[20]; S[20] = ROTL64(B, 62); B = A;
    A = S[14]; S[14] = ROTL64(B, 18); B = A;
    A = S[22]; S[22] = ROTL64(B, 39); B = A;
    A = S[ 9]; S[ 9] = ROTL64(B, 61); B = A;
    A = S[ 6]; S[ 6] = ROTL64(B, 20); B = A;
    A = S[ 1]; S[ 1] = ROTL64(B, 44); B = A;
