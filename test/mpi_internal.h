...
test_mpn_addsub(mp_rng_f *rng, void *arg) {
  ...
  for (i = 0; i < 100; i++) {
    ...
    ASSERT(mpn_cmp2(zp, zn, xp, xn) > 0);
    ASSERT(mpn_cmp2(zp, zn, yp, yn) > 0);
